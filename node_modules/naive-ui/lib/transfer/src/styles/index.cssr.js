...
const animation = (0, cssr_1.c)([(0, cssr_1.c)('@keyframes transfer-slide-in-from-left', `
 ...
 `), (0, cssr_1.c)('@keyframes transfer-slide-out-to-right', `
 0% {
 transform: translateX(0);
 }
 100% {
 ...
 `), (0, cssr_1.c)('@keyframes transfer-slide-in-from-right', `
 0% {
 transform: translateX(150%);
 }
 100% {
 ...
 `), (0, cssr_1.c)('@keyframes transfer-slide-out-to-left', `
 0% {
 transform: translateX(0);
 }
 100% {
 ...
 `), (0, cssr_1.c)('@keyframes transfer-height-collapse', `
 0% {
 ...
 `), (0, cssr_1.c)('@keyframes transfer-height-expand', `
 0% {
 max-height: 0;
 }
 100% {
 ...
 `)]);
exports.default = (0, cssr_1.c)([(0, cssr_1.cB)('transfer', `
 display: flex;
 width: var(--n-width);
 ...
 display: flex;
 flex-wrap: nowrap;
 `, [(0, cssr_1.cB)('transfer-icon', `
 color: var(--n-icon-color);
 transition: color .3s var(--n-bezier);
 `), (0, cssr_1.cM)('disabled', [(0, cssr_1.cB)('transfer-icon', {
 ...
 `)]), (0, cssr_1.cB)('transfer-list-body', `
 flex-basis: 0;
 flex-grow: 1;
 box-sizing: border-box;
 position: relative;
 ...
 `), (0, cssr_1.cB)('transfer-list-flex-container', `
 flex: 1;
 position: relative;
 ...
 margin: 0;
 position: relative;
 `, [(0, cssr_1.cM)('transition-disabled', [(0, cssr_1.cB)('transfer-list-item', {
  animation: 'none !important'
})]), (0, cssr_1.cB)('transfer-list-item', `
