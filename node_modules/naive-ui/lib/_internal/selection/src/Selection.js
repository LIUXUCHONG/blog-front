...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        if (multiple) {
            ...
            })) : ((0, vue_1.h)(tag_1.NTag, { size: size, closable: !option.disabled, disabled: disabled, onClose: () => this.handleDeleteOption(option), internalCloseFocusable: false, internalStopClickPropagation: true }, {
                default: () => renderLabel
